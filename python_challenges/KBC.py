...
def lifeline50(questioninfo):
    """
    Implements the 50/50 lifeline: removes two incorrect options.
    Returns a list of indices of options to hide.
    """
    global lifeline50 
...
def playkbc():
    """This function runs the entire KBC game."""
    global currentmoney 
    ...
    for i, questioninfo in enumerate(questiondata):
        ...
        if playerchoice - 1 == questioninfo['correct_answer_index']:
            ...
            print(f"Game Over! You walk away with ${currentmoney:,}!") 
            break 
